      ...
      <div className="w-full lg:w-1/2 md:px-4 lg:px-6 py-5">
        <div className="bg-white hover:shadow-xl">
          ...
          <div className="px-4 py-4 md:px-10">
            ...
            <p className="py-4">
            เทคโนโลยี IoT ( Internet of Things ):จะเข้ามาช่วยในเรื่องของการ ตรวจจับและแจ้งเตือนช้างป่าได้อย่างรวดเร็วและ แม่นยำแบบ ซึ่งจะช่วยแก้ไขข้อจำกัดของระบบเดิม ได้แก่ การแจ้งเตือนล่าช้า และการเฝ้าระวังที่ไม่ครอบคลุม ตลอด 24 ชั่วโมง ทำให้ เจ้าหน้าที่และชุมชนมีเวลาเตรียมรับมือและผลักดันช้างได้อย่างทันท่วงที ลดความเสียหายต่อพืชผล ทรัพย์สิน และอันตรายต่อชีวิต
            </p>
